const questions = [
  ...
  },
  {
    ...
    options: ["Majapahit", "Sriwijaya", "Tarumanegara", "Mataram"],
    answer: 1,
  },
  {
  ...
  },
  {
    ...
    options: ["Demak", "Samudra Pasai", "Mataram Islam", "Aceh"],
    answer: 1,
  },
  {
  ...
  {
    question: "8.Apa tujuan dari Perjanjian Renville?",
    options: [
      "Mengakhiri konflik Indonesia-Belanda",
      "Mengukuhkan Belanda sebagai penjajah",
      "Mendirikan Republik Indonesia Serikat",
      "Membagi wilayah kekuasaan antara Indonesia dan Jepang",
    ],
    answer: 0,
  },
  {
  ...
  {
    question: "10.  Apa isi dari Tri Koro Dharmo?",
    options: [
      "Kesatuan, Kebangsaan, dan Kemerdekaan",
      "Kesetiakawanan, Keberanian, dan Persatuan",
      "Kebangsaan, Kemanusiaan, dan Keindonesiaan",
      "Perjuangan, Persatuan, dan Kesetiaan",
    ],
    answer: 0,
  },
];
